...
class NanoporeSequencingRun(Entity):
    ...
    def __init__(
            ...
            timestamp_acquisition_started: Optional[datetime.datetime]=None,
            timestamp_acquisition_stopped: Optional[datetime.datetime]=None,
            timestamp_processing_stopped: Optional[datetime.datetime]=None,
        ...
        self.timestamp_acquisition_started = timestamp_acquisition_started
        self.timestamp_acquisition_stopped = timestamp_acquisition_stopped
